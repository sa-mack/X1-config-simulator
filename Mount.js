export class Mount {
    constructor(options) {
      ...
      this.crewRequired = options.crewRequired;
...
export const mounts = [MOUNT_SENSOR_ARRAY_II, MOUNT_LASER_CANNON_I, MOUNT_MINING_LASER_I, MOUNT_MINING_LASER_II, MOUNT_MINING_LASER_III, MOUNT_SURVEYOR_I, MOUNT_SURVEYOR_II, MOUNT_SURVEYOR_III, MOUNT_GAS_SIPHON_III, MOUNT_TURRET_I];
// let MOUNT_GAS_SIPHON_I;
// let MOUNT_GAS_SIPHON_II;
// let MOUNT_SENSOR_ARRAY_I;
