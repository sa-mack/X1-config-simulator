...
export const FRAME_LIGHT_FREIGHTER = new Frame("FRAME_LIGHT_FREIGHTER", "Frame Light Freighter", 5, 40, 1700, 6, 1);
...
export const FRAME_INTERCEPTOR = new Frame("FRAME_INTERCEPTOR", "Frame Interceptor", 1, 5, 500, 2, 2);
...
export const FRAME_DRONE = new Frame("FRAME_DRONE", "Frame Drone", 1, 0, 100, 3, 2);
